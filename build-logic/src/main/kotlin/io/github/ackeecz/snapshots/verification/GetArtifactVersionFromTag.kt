...
internal class GetArtifactVersionFromTagImpl(
    ...
    private inner class Impl(private val project: Project) {
        ...
        private fun parseVersionFromProperties(
            ...
            return try {
                ...
                if (project.version.toString().isInitialLibraryVersion()) {
                    return null
                } else {
        ...
        private fun handleFirstCommitHashResult(): ArtifactVersion? {
            ...
            if (projectVersion.isInitialLibraryVersion()) {
                return null
            } else {
    ...
    companion object {
        ...
        // Initial library versions start with the versions used when migrated to the BOM versioning
        // system to work with the related verification logic that expects the tags to be in a
        // specific format, that is different from the previous "v*" release tags.
        private const val INITIAL_COMMON_LIBRARY_VERSION = "2.0.0"
        private const val INITIAL_PAPARAZZI_LIBRARY_VERSION = "2.0.0-paparazzialpha02"

        private fun String.isInitialLibraryVersion(): Boolean {
            return this == INITIAL_COMMON_LIBRARY_VERSION || this == INITIAL_PAPARAZZI_LIBRARY_VERSION
        }
    }
}
