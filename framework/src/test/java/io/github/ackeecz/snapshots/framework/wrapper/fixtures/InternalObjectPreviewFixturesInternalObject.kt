...
internal val InternalObjectPreviewFixturesInternalObject: ShowkaseBrowserComponent = ShowkaseBrowserComponent(
    group = "Fixtures",
    componentName = "InternalObject",
    componentKDoc = "",
    componentKey = "${ENCLOSING}_InternalObjectPreview_${ENCLOSING}_Fixtures_InternalObject_0_null",
    isDefaultStyle = false,
    extraMetadata = listOf("component"),
    component = @Composable { FixtureObject.InternalObjectPreview() },
)
